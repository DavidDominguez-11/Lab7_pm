...
fun MealCategoriesMainApp() {
    ...
    val categorizedMeals: MutableState<List<Category>> = //Almacenar todas las categorías en una lista de estado mutable
...
@Composable
fun CategoryItem(meal: Category, context: Context) {
    ...
    Box(
        modifier = Modifier
            ...
            .clickable {
                ...
                intent.putExtra("category", meal.strCategory) // Agrega el valor de la categoría como un extra
        ...
        Column(
            ...
            //Imagen de la comida
            val painter = rememberAsyncImagePainter(model = meal.strCategoryThumb)
            Image(
                painter = painter,
